...
var link = ({ children, value }) => (0, import_jsx_runtime.jsx)("a", { href: value == null ? void 0 : value.href, children });
...
var defaultMarks = {
  ...
  underline: ({ children }) => (0, import_jsx_runtime.jsx)("span", { style: underlineStyle, children }),
...
var DefaultUnknownType = ({
  ...
  return isInline ? (0, import_jsx_runtime.jsx)("span", { style: hidden, children: warning }) : (0, import_jsx_runtime.jsx)("div", { style: hidden, children: warning });
};
var DefaultUnknownMark = ({
  markType,
  children
}) => (0, import_jsx_runtime.jsx)("span", { className: `unknown__pt__mark__${markType}`, children });
var DefaultUnknownBlockStyle = ({
  children
}) => (0, import_jsx_runtime.jsx)("p", { children });
var DefaultUnknownList = ({ children }) => (0, import_jsx_runtime.jsx)("ul", { children });
var DefaultUnknownListItem = ({
  children
}) => (0, import_jsx_runtime.jsx)("li", { children });
...
function PortableText({
  ...
  const handleMissingComponent = missingComponentHandler || noop, blocks = Array.isArray(input) ? input : [input], nested = nestLists(blocks, listNestingMode || LIST_NEST_MODE_HTML), components = (0, import_react.useMemo)(() => componentOverrides ? mergeComponents(defaultComponents, componentOverrides) : defaultComponents, [componentOverrides]), renderNode = (0, import_react.useMemo)(
    () => getNodeRenderer(components, handleMissingComponent),
    [components, handleMissingComponent]
  ), rendered = nested.map(
    (node, index) => renderNode({ node, index, isInline: false, renderNode })
  );
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: rendered });
}
var getNodeRenderer = (components, handleMissingComponent) => {
  ...
  function renderListItem(node, index, key) {
    ...
    return (0, import_jsx_runtime.jsx)(Li, { value: node, index, isInline: false, renderNode, children }, key);
  }
  function renderList(node, index, key) {
    ...
    return (0, import_jsx_runtime.jsx)(List, { value: node, index, isInline: false, renderNode, children }, key);
  }
  function renderSpan(node, _index, key) {
    ...
    return Span === components.unknownMark && handleMissingComponent(unknownMarkWarning(markType), { nodeType: "mark", type: markType }), (0, import_jsx_runtime.jsx)(
      Span,
      {
  ...
  function renderBlock(node, index, key, isInline) {
    ...
    return Block === components.unknownBlockStyle && handleMissingComponent(unknownBlockStyleWarning(style), {
      nodeType: "blockStyle",
      type: style
    }), (0, import_jsx_runtime.jsx)(Block, { ...props, value: props.node, renderNode }, key);
  }
